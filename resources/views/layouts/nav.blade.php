    ...
    <div class="container tab-pane active">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
            ...
            <div class="col-md-3 text-end">
                <button type="button" class="btn btn-outline-primary me-2 rounded-pill" style="border-color:#ff6537ff; color:#ff6537ff"><a href="/login" style="text-decoration:none; color: #ff6537ff">Login</a></button>
                <button type="button" class="btn btn-primary rounded-pill" style="background-color:#ff6537ff;border-color:#ffffff"><a href="/signup" style="text-decoration:none; color:white;">Sign-up</a></button>
